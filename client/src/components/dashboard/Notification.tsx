  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-6 py-4 rounded-b-2xl bg-[#161E54]">
          <div className="pb-2">
            ...
            <h1 className="py-3 text-xl text-white font-semibold">
          ...
          <div className="flex items-center mt-4">
            <div className="w-1/2">
              <h1 className="text-white text-sm">Today you makes 12 Activity</h1>
            </div>

            <div className="w-1/2 flex justify-end">
              <button
                type="button"
                className="px-4 py-2 rounded-md text- text-white bg-red-500"
              >
                See All Activity
              </button>
            </div>
      ...
      <div className="md:w-[60%] lg:w-auto">
        <div className="border-slate-300 border mt-2 rounded-lg">
          <div className="px-4 py-2">
            <div>
              <h1 className="text-base">Upcoming Schedule</h1>
            </div>
            ...
            <div className=" h-72 overflow-auto scrollbar-none">
              ...
              <div>
                ...
                <div className="px-5 py-2 bg-slate-50 rounded-md flex items-center mb-2">
                  <div className="w-[80%] ">
                    <h1 className="text-sm">Review candidate applications</h1>
                    <h5 className="text-sm text-gray-500">Todays - 11.30 AM</h5>
                  </div>
                  <div className="w-[20%] flex justify-end items-center">
                    <button type="button">
