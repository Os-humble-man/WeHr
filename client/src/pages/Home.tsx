...
function Home() {
    ...
    const isActive = (pash: string) => (Location.pathname === pash ? "text-red-500" : "text-gray-600");
    ...
    return (
        <>
            <section className='md:flex font-[Poppins] bg-slate-50'>
                {/* la partie de menu */}
                <div className={`bg-slate-50 fixed inset-0 h-screen z-20 overflow-auto px-4 py-2 border-r-2 border-stone-300 md:static  lg:w-64
